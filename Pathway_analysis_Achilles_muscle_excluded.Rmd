...
Specifically this script is to analyse the results of the DEseq2 LRT test of Achilles data where muscle was excluded.  
...
This is for when muscle was not included

```{r}
celltypes <- c("Adipocyte", "Fasttwitch", "ITGA10Fibroblasts", 
               "Macrophages", "NEGR1Fibroblasts", "VEC")

clusters <- list()

for (i in seq(1:length(celltypes))){
    clusters[[i]] <- read.csv(paste0("20240419_10-19_Pseudobulk.dir/Cluster_results/", celltypes[[i]], "_df.csv"))
}
...
genelists_upregulated <- list(Fasttwitch_2, ITGA10Fibroblasts_2, Macrophages_2, 
                              NEGR1Fibroblasts_1, VEC_1 )
names(genelists_upregulated) <- c("Fasttwitch", "ITGA10Fibroblasts", "Macrophages", "NEGR1Fibroblasts", "VEC")
...
Adipocyte cluster 1
Fasttwitch group 1
ITGA10fibroblasts group 4
NEGR1 Fibroblasts group 2
...
genelists_downregulated <- list(Adipocyte_1, Fasttwitch_1, ITGA10Fibroblasts_4, NEGR1Fibroblasts_2 )
names(genelists_downregulated) <- c("Adipocyte", "Fasttwitch", "ITGA10Fibroblasts", "NEGR1Fibroblasts")
```
