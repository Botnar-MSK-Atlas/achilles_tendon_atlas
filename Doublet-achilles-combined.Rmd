...
file_list_auto_sce <- list.files(paste0(ini$soupX_auto_files, "_SoupX_Auto.dir/RDS_objects.dir/SingleCellExp/"), 
                                 pattern="_SingleCellExp.rds")

names(file_list_auto_sce) <- str_replace(file_list_auto_sce, "_filtered_soupX_SingleCellExp.rds", "")

file_list_auto_so <- list.files(paste0(ini$soupX_auto_files, "_SoupX_Auto.dir/RDS_objects.dir/Seurat/"), 
...
for (i in 1:length(file_list_auto_sce)){
    ...
    sce_auto[[i]] <- readRDS(paste0(ini$soupX_auto_files, 
                               "_SoupX_Auto.dir/RDS_objects.dir/SingleCellExp/",
                                                file_list_auto_sce[i]))
    so_auto[[i]] <- readRDS(paste0(ini$soupX_auto_files, 
                               "_SoupX_Auto.dir/RDS_objects.dir/Seurat/",
                                                file_list_auto_so[i]))
}
...
file_list_manual_sce <- list.files(paste0(ini$soupX_manual_files, "_SoupX_Manual.dir/RDS_objects.dir/SingleCellExp/"), 
                                 pattern="_SingleCellExp.rds")

names(file_list_manual_sce) <- str_replace(file_list_manual_sce, "_filtered_soupX_SingleCellExp.rds", "")

file_list_manual_so <- list.files(paste0(ini$soupX_manual_files, "_SoupX_Manual.dir/RDS_objects.dir/Seurat/"), 
                                 pattern="SeuratObject.rds")
...
for (i in 1:length(file_list_manual_sce)){
    ...
    sce_manual[[i]] <- readRDS(paste0(ini$soupX_manual_files, 
                               "_SoupX_Manual.dir/RDS_objects.dir/SingleCellExp/",
                                                file_list_manual_sce[i]))
    so_manual[[i]] <- readRDS(paste0(ini$soupX_manual_files, 
                               "_SoupX_Manual.dir/RDS_objects.dir/Seurat/",
