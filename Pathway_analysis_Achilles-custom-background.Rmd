...
Here we will test using the background of all genes, versus using specific backgrounds. 
1. all genes expressed in the Seurat object across cell types  
2. all genes expressed in Seurat object per cell type  
3. All genes expressed in the results of DEseq2   
...
Read in the results and create celltype specific lists of expressed genes
```{r}
lrt_genes <- list()

for (i in seq(1:length(celltypes))){
    lrt_results <- read.csv(paste0("20240421_20-48_Pseudobulk.dir/DEseq2_results/", celltypes[[i]], "_MBvsEnth_lfcshrink.csv"), 
                                 row.names = 1)
    lrt_genes[[i]] <- rownames(lrt_results)
}

names(lrt_genes) <- celltypes
...
upregulated_GOBP_universe <- run_enricher(genelists_upregulated, "Upregulated_GOBP_universe", 
            GOBP_reference, NULL)
upregulated_GOBP_custom <- run_enricher(genelists_upregulated, "Upregulated_GOBP_custom", 
            GOBP_reference, expressed_genes_all)
...
upregulated_GOBP_custom_LRT <- run_enricher(genelists_upregulated, "Upregulated_GOBP_custom_LRT", 
                                            GOBP_reference, lrt_genes)

downregulated_GOBP_universe <- run_enricher(genelists_downregulated, "Downregulated_GOBP_universe", 
            GOBP_reference, NULL)
downregulated_GOBP_custom <- run_enricher(genelists_downregulated, "Downregulated_GOBP_custom", 
            GOBP_reference, expressed_genes_all)
downregulated_GOBP_custom_cell <- run_enricher(genelists_downregulated, "Downregulated_GOBP_custom_cell", 
            GOBP_reference, expressed_genes)
downregulated_GOBP_custom_LRT <- run_enricher(genelists_downregulated, "Downregulated_GOBP_custom_LRT", 
                                            GOBP_reference, lrt_genes)

tendon_high_GOBP_universe <- run_enricher(genelists_tendon_high, "Tendon_high_GOBP_universe", 
            GOBP_reference, NULL)
tendon_high_GOBP_custom <- run_enricher(genelists_tendon_high, "Tendon_high_GOBP_custom", 
            GOBP_reference, expressed_genes_all)
tendon_high_GOBP_custom_cell <- run_enricher(genelists_tendon_high, "Tendon_high_GOBP_custom_cell", 
            GOBP_reference, expressed_genes)
tendon_high_GOBP_custom_LRT <- run_enricher(genelists_tendon_high, "Tendon_high_GOBP_custom_LRT", 
                                            GOBP_reference, lrt_genes)

muscle_high_GOBP_universe <- run_enricher(genelists_muscle_high, "muscle_high_GOBP_universe", 
            GOBP_reference, NULL)
muscle_high_GOBP_custom <- run_enricher(genelists_muscle_high, "muscle_high_GOBP_custom", 
            GOBP_reference, expressed_genes_all)
muscle_high_GOBP_custom_cell <- run_enricher(genelists_muscle_high, "muscle_high_GOBP_custom_cell", 
            GOBP_reference, expressed_genes)
muscle_high_GOBP_custom_LRT <- run_enricher(genelists_muscle_high, "muscle_high_GOBP_custom_LRT", 
                                            GOBP_reference, lrt_genes)
...
plot_enricher <- function(enricher_result, description){
 ...
 plot_enricher(upregulated_GOBP_universe, "Upregulated_GOBP_universe")
 plot_enricher(upregulated_GOBP_custom, "Upregulated_GOBP_custom")
 plot_enricher(upregulated_GOBP_custom_cell, "Upregulated_GOBP_custom_cell")
 plot_enricher(upregulated_GOBP_custom_LRT, "Upregulated_GOBP_custom_LRT")
 
 plot_enricher(downregulated_GOBP_universe, "Downregulated_GOBP_universe")
 plot_enricher(downregulated_GOBP_custom, "Downregulated_GOBP_custom")
 plot_enricher(downregulated_GOBP_custom_cell, "Downregulated_GOBP_custom_cell")
 plot_enricher(downregulated_GOBP_custom_LRT, "Downregulated_GOBP_custom_LRT")
 
 plot_enricher(tendon_high_GOBP_universe, "Tendon_high_GOBP_universe")
 plot_enricher(tendon_high_GOBP_custom, "Tendon_high_GOBP_custom")
 plot_enricher(tendon_high_GOBP_custom_cell, "Tendon_high_GOBP_custom_cell")
 plot_enricher(tendon_high_GOBP_custom_LRT, "Tendon_high_GOBP_custom_LRT")
 
 plot_enricher(muscle_high_GOBP_universe, "Muscle_high_GOBP_universe")
 plot_enricher(muscle_high_GOBP_custom, "Muscle_high_GOBP_custom")
 plot_enricher(muscle_high_GOBP_custom_cell, "Muscle_high_GOBP_custom_cell")
 plot_enricher(muscle_high_GOBP_custom_LRT, "Muscle_high_GOBP_custom_LRT")
```
...
plot_dotplot(upregulated_GOBP_universe, "Upregulated_GOBP_universe")
plot_dotplot(upregulated_GOBP_custom, "Upregulated_GOBP_custom")
plot_dotplot(upregulated_GOBP_custom_cell, "Upregulated_GOBP_custom_cell")
plot_dotplot(upregulated_GOBP_custom_LRT, "Upregulated_GOBP_custom_LRT")
 
plot_dotplot(downregulated_GOBP_universe, "Downregulated_GOBP_universe")
plot_dotplot(downregulated_GOBP_custom, "Downregulated_GOBP_custom")
plot_dotplot(downregulated_GOBP_custom_cell, "Downregulated_GOBP_custom_cell")
plot_dotplot(downregulated_GOBP_custom_LRT, "Downregulated_GOBP_custom_LRT")
 
plot_dotplot(tendon_high_GOBP_universe, "Tendon_high_GOBP_universe")
plot_dotplot(tendon_high_GOBP_custom, "Tendon_high_GOBP_custom")
plot_dotplot(tendon_high_GOBP_custom_cell, "Tendon_high_GOBP_custom_cell")
plot_dotplot(tendon_high_GOBP_custom_LRT, "Tendon_high_GOBP_custom_LRT")
 
plot_dotplot(muscle_high_GOBP_universe, "Muscle_high_GOBP_universe")
plot_dotplot(muscle_high_GOBP_custom, "Muscle_high_GOBP_custom")
plot_dotplot(muscle_high_GOBP_custom_cell, "Muscle_high_GOBP_custom_cell")
plot_dotplot(muscle_high_GOBP_custom_LRT, "Muscle_high_GOBP_custom_LRT")
    
```


Conclusion: 
Custom backgrounds, however they are created, basically make no difference in this case. 
So the pathways must be very strongly enriched!
