...
names(achilles.colours_0.1) <- c("Macrophages", "Vascular endothelial cells",  "Skeletal muscle cells",  "Adipocytes", "T cells", "Nervous system cells", "Lymphatic endothelial cells", "Mural cells", "Fibroblasts", "Granulocytes", "Satellite cells", "B plasma cells",  "B cells")
...
p2 <- plotNhoodGraph(achilles_milo, layout="UMAP.SCVI", colour_by=ini$cell_labels) +    
    scale_fill_manual(values=achilles.colours_0.1) +
