...
for (i in unique(mouse_achilles$subpopulation)){
    ...
    if (i != "Nerve cells 2"){ # this cell type doesn't work as no genes are found in the so
        ...
        slice_max(n=50, order_by = desc(p_val_adj)) %>% 
...
DotPlot(so.fibroblasts, 
    ...
    theme(plot.title = element_text(size = 14, face = "bold"))+
    theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+coord_flip()
    ggsave(paste0(directory, "/Top_9_Dotplots/Cluster_0v2.png"), width = 7, height =7, bg = "white")
```
```{r}
...
DotPlot(so.fibroblasts, 
    ...
    theme(plot.title = element_text(size = 14, face = "bold"))+
    theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+coord_flip()
    ggsave(paste0(directory, "/Top_9_Dotplots/Cluster_2v0.png"), width = 7, height =7, bg = "white")
```
...
DotPlot(so.fibroblasts, 
    ...
    theme(plot.title = element_text(size = 14, face = "bold"))+
    theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+coord_flip()
    ggsave(paste0(directory, "/Top_9_Dotplots/Cluster_2v6.png"), width = 7, height =7, bg = "white")
```
CFD, MIR3171HG
