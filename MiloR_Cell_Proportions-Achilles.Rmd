...
p1 <- plotNhoodGraphDA(achilles_milo, layout="HARMONY.UMAP", milo_res=da_results, alpha=0.1)+
    scale_fill_gradient2(low = "#001418", mid = "#FFFFFF", high = "#6e1e0a", midpoint = 0, name = "logFC")
p1
...
plotDAbeeswarm(da_results, group.by = ini$cell_labels)+
    ...
    scale_colour_gradient2(low = "#001418", mid = "#FFFFFF", high = "#6e1e0a", midpoint = 0, name = "logFC")
